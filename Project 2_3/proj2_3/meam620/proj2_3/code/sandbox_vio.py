...
while True:
    ...
    info.append((nominal_state[-2].copy(), nominal_state[-1].copy()))
...
#%%
plt.figure()
plt.plot(w_b[:, 0], label='ax')
plt.plot(w_b[:, 1], label='ay')
plt.plot(w_b[:, 2], label='az')
plt.title('w_b')
plt.legend()
plt.show()
...
#%%
plt.figure()
plt.plot(g[:, 0], label='ax')
plt.plot(g[:, 1], label='ay')
plt.plot(g[:, 2], label='az')
plt.title('g')
plt.legend()
plt.show()
